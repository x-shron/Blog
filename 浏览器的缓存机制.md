...
![image](https://github.com/user-attachments/assets/8d8c6fd8-ace2-40d8-b302-d077f497a4c6)
![image](https://github.com/user-attachments/assets/cd87b455-ba7c-4669-8af8-2c84237def08)
...
![image](https://github.com/user-attachments/assets/511c6830-618d-49f0-8b41-8a8f07afe212)
...
不存在该缓存结果和缓存标识，强制缓存失效，则直接向服务器发起请求（跟第一次发起请求一致），如下
...
我们直接看一个例子，如下：
  ![image](https://github.com/user-attachments/assets/a21484ca-7290-4278-8ef3-3f1917c083f6)

由上面的例子我们可以知道：
 1. HTTP响应报文中expires的时间值，是一个绝对值
 2. HTTP响应报文中Cache-Control为max-age=31536000，是相对值
...
>
![image](https://github.com/user-attachments/assets/40002848-ec27-4ce0-84bb-212977da0910)
...
1. 协商缓存生效，返回304
   ...
   ![image](https://github.com/user-attachments/assets/353e21eb-07cd-4575-a213-915293573d22)

2. 协商缓存失效，返回200和请求结果结果

   ![image](https://github.com/user-attachments/assets/b297bb2f-e1d0-40ea-9a83-a70d2c8d230a)
...
![image](https://github.com/user-attachments/assets/e7c80c15-1bc2-4664-af9a-58ce44cd2266)
